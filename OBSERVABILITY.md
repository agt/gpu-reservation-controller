...
| Level | Message | Description |
|-------|---------|-------------|
| WARNING | `Pod ns/name has non-integer dsmlp/minimum-runtime-seconds='value'; ignoring` | The `dsmlp/minimum-runtime-seconds` annotation is not a positive integer; the pod will not be treated as an on-demand candidate. |
